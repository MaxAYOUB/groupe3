...
<div class="container" style="margin: 5% 20% 0 20%;background-color: #f2f2f2; padding-bottom: 5%">
<div class="container" style="background-color: #f2f2f2; height: auto">
    ...
    <div id="divGalerie" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <img id="imgListe" src="images/Image-1.png" style="width: 100px">
        <img id="imgListe" src="images/Image-1.png" style="width: 100px">
        <img id="imgListe" src="images/Image-1.png" style="width: 100px">
        <img id="imgListe" src="images/Image-1.png" style="width: 100px">
        <img id="imgListe" src="images/Image-1.png" style="width: 100px">
    ...
    <div id="divGalerieBtn" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <button id="btn2" type="button" class="btn btn-default col-xs-4 col-xs-offset-1 col-sm-2 col-sm-offset-3" data-toggle="modal" data-target="#myModal1">Supprimer</button>
        <button id="btn1" type="button" class="btn btn-success col-xs-4 col-xs-offset-2 col-sm-2 col-sm-offset-2" data-toggle="modal" data-target="#myModal">Ajouter
    </div>
</div>
                            ...
                            <form method="POST" action="reception.php" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-file" name="mon_fichier">
                                        ...
                                        <input style="margin-bottom:9px " type="text" class="form-control" placeholder ='Choisir votre fichier...' />
                                        <span class="input-group-btn">
